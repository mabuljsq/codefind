...
from codefind.versioncheck import VERSION_CHECK_FNAME

# GitHub issues URL for CodeFind
GITHUB_ISSUES = "https://github.com/codefind-ai/codefind/issues"
...
def report_github_issue(issue_text, title=None, confirm=True):
    ...
    :return: None
    """
    version_info = f"CodeFind version: {__version__}\n"
    ...
    if confirm:
        ...
        print()
        print("Please consider reporting this bug to help improve CodeFind!")
