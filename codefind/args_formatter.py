...
# URLs module removed - CodeFind focuses on Bedrock documentation
...
class DotEnvFormatter(argparse.HelpFormatter):
    ...
    def _format_text(self, text):
        return f"""
##########################################################
# Sample codefind .env file.
# Place at the root of your git repo.
# Or use `codefind --env <fname>` to specify.
#
# CodeFind supports dynamic .env file discovery:
# - Environment-specific files (.env.local, .env.development, etc.)
# - Directory traversal (walks up from current directory)
# - Standard search paths (home, git root, current dir)
# Use --no-dynamic-env to disable dynamic discovery.
##########################################################
...
## Environment indicator (used for dynamic .env discovery)
...
# https://codefind.ai/docs/config/dotenv.html
